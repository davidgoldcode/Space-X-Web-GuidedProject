...
jest.mock('./api/fetchMissions'); // mocks ALL exports coming from that file 
...
test('render missions when api is called', async () => {
    ...
    // JS enginge won't run any code below here until the promise is resolved

    // expect(screen.getAllByTestId(/missions/i)).toHaveLength(2); purposely break
